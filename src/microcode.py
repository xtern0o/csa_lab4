...
FETCH_DISPATCH_SRC = add_block("FETCH", [
    MicroInstruction(
...
DST_PRE_DEC = add_block("DST_PRE_DEC_FETCH", [
    ...
    MicroInstruction(
        # восстановить source operand в TMP2!!!
        reg_src_sel=0xF,
...
DST_POST_INC = add_block("DST_POST_INC_FETCH", [
    # сохранить адрес и прочитать operand
    MicroInstruction(
        reg_dst_sel=0xF,
...
WB_INDIRECT = add_block("WB_INDIR", [
    MicroInstruction(
        reg_dst_sel=0xF,
