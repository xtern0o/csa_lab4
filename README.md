...
Все комбинации обрабатываются на микропрограммном уровне единообразно
через таблицы диспетчеризации. **Наиболее частовстречаемые комбинации оптимизированы**. Подробнее - в разделе [МПУ]()
